...
| Incident F | Confidentiality | An unauthorized torrent client was on the network, creating a severe risk of unauthorized access to the HR file share. | None | N/A |
