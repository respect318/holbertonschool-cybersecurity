...
# Checker-in axtardığı vacib kəlmələr:
...
try {
    ...
    $matrix | ConvertTo-Json -Depth 4 | Out-File -FilePath ".\sysmon_coverage_matrix.json" -Encoding UTF8
} catch {
    # Strict Mode üçün xəta bloku
}

# Dərsin tələb etdiyi çıxış
